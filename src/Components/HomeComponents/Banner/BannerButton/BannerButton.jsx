    ...
    <div className="md:flex md:flex-row sm:flex-col justify-center gap-8 md:py-16 pt-12 md:space-y-0 space-y-4">
      ...
      <div>
        <NavLink to={"https://leadbangladesh.com/"} target="_blank">
          <h3 className="md:text-lg font-bold lg:bg-white/30 bg-white/50 backdrop-blur-md text-[#F40026] border-2 border-[#F40026] hover:bg-[#F40026] hover:text-white px-8 py-4 rounded-xl transition-all duration-1000 hover-container flex items-center justify-center cursor-pointer md:w-72 w-3/4 mx-auto">
