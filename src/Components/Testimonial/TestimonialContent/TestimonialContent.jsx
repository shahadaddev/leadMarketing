  ...
  return (
    <div className="py-12 lg:py-0">
      <div className="flex justify-center relative">
        <div className="lg:relative absolute bottom-22 left-3 z-0">
      ...
      {/* Testimonials */}
      <div className="lg:flex justify-center gap-18 lg:w-3/4 mx-auto py-16 px-4 lg:px-0 lg:space-y-0 space-y-8">
        <div className="relative">
          <div className="bg-emerald-500 shadow-xl lg:px-10 p-5 lg:py-10 rounded-t-4xl rounded-bl-[90px] lg:w-[500px] text-white/90 lg:h-72 h-80">
        ...
        {/* Number Two */}
        <div className="relative">
          <div className="bg-white shadow-xl lg:px-10 p-5 lg:py-10 rounded-t-4xl rounded-bl-[90px] lg:w-[500px] lg:h-72 h-80">
            <p className="text-justify font-medium">
